...
- [x] **Stores data in MongoDB** - stores the succuletn in mongodb
- [x] **Stores credentials in MongoDB** - stores the login in mongo

## 🚀 WebSocket deliverable

For this deliverable I did the following. I checked the box `[x]` and added a description for things I completed.

- [x] **Backend listens for WebSocket connection** - Implemented in the gallery feature
- [x] **Frontend makes WebSocket connection** - Implemented in the gallery feature
- [x] **Data sent over WebSocket connection** - Implemented in the gallery feature
- [x] **WebSocket data displayed** - Implemented in the gallery feature
